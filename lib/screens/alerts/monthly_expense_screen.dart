...
//     final categoryData =
//         ((expenseProvider.getCategoryTotals(selectedMonth) ?? {}) as Map).map(
...
class _MonthlySummaryScreenState extends State<MonthlySummaryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final double total =
        (expenseProvider.getTotalForMonth(selectedMonth) as num?)?.toDouble() ??
        0.0;
    ...
    double percentUsed = monthlyBudget == 0 ? 0 : total / monthlyBudget;
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDonutChart(categoryData, total),
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          "vs Rs ${monthlyBudget.toStringAsFixed(0)} Budget",
                          style: TextStyle(color: Colors.grey.shade500),
                        ),
